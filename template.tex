...
% This results in an options clash I was unable to resolve
% solved by changing the color names in hypersetup to be standard names provided
% by the color package by default.
$endif$
